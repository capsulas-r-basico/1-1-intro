...
**¡Es muy versátil!** Hoy es utilizado para abordar problemas de **distintas disciplinas**.

--

Posiblemente, las **técnicas o metodologías más recientes tengan alguna aplicación en R**. Los investigadores muchas veces publican código en compañía de sus artículos.

--

**R está hecho para el análisis de datos**.
...
**Poderosas herramientas para comunicar resultados**. Varios paquetes en **R** facilitan la creación de reportes en pdf o en html.

--

**Entorno de desarrollo** diseñado especialmente para el lenguaje R (**RStudio**).
...
.medium-par[**Documentos metodológicos Encuesta de Presupuestos Familiares (EPF):**]
